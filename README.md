...
### Чему новому я научился в этом проекте?

* Работать с gulp, и понимание для чего он вообще нужен
* Создавать универсальные модальные окна
* Создавать универсальный таймер
* Создавать табы
* Общее понимание создания универсальных функции, в которые просто нужно будет подставлять нужные селкеторы. Не меняя js логики
* Ну и вообще понимание как работать на заказчика, и с какими проектами можно столкнуться
