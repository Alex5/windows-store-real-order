...
* Создавать табы
* Общее понимаю создания универсальных функции, в которые просто нужно будет подставлять нужные селкторы. Не меняя js логики
* Ну и вообще понимание как рботать на заказчика, и с какими проектами можно столкнуться
