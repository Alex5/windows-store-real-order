...
var forms = function forms() {
  ...
  var message = {
    loading: 'Загрузка...',
    success: 'Спасибоб скоро с вами свяжуться',
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    var target = e.target;
    var childNode = target.classList.contains(tabSelector.replace(/\./, ''));
    var parentNode = target.parentNode.classList.contains(tabSelector.replace(/\./, ''));

    if (target && childNode || parentNode) {
